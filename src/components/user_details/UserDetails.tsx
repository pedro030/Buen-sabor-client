        ...
        <Form className='grid grid-cols-2 gap-4 place-content-center'>
          <div className='flex flex-col items-center justify-center'>
            <div>
              ...
              <Field name="firstName" type="text" className="w-96 input input-bordered input-primary" />
            </div>
            <div>
              <label className='label' htmlFor="lastName"><span className="label-text">Last Name</span></label>
              <Field type="text" name="lastName" className="w-96 input input-bordered input-primary" />
            </div>
            <div>
              <label className='label' htmlFor="email"><span className="label-text">Email</span></label>
              <Field name="email" type="email" className="w-96 input input-bordered input-primary" />
            </div>
          </div>
          <div className='flex flex-col items-center justify-center'>
            <div>
              <label className='label' htmlFor="birthdate"><span className="label-text">Birthdate</span></label>
              <Field name="birthdate" type="date" className="w-96 input input-bordered input-primary" />
            </div>
            <div>
              <label className='label' htmlFor="phone_number"><span className="label-text">Number Cell Phone</span></label>
              <Field type="text" name="phone_number" className="w-96 input input-bordered input-primary" />
            </div>
            <div>
              <label className='label' htmlFor="gender"><span className="label-text">Gender </span></label>
              <Field name="gender" type="text" className="w-96 input input-bordered input-primary" />
            </div>
          </div>
        </Form>
      </Formik>
